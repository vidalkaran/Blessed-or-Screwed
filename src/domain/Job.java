...
public class Job {
	...
	private ArrayList<String> promotions;	// ArrayList holding the  names of the classes this class Promotes to. EMPTY ARRAY if none
	...
	public String toString() {
		...
		String allPromotions = Arrays.toString(promotions.toArray());
